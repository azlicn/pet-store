...
class UserInUseExceptionTest {
    ...
    void constructor_WithOwnedPetsOnly_ShouldCreateCorrectMessage() {
        ...
        assertThat(exception.getMessage())
            .isEqualTo("Cannot delete user 'user@test.com' (ID: 1) because they have ownership of 2 pet(s) that still exist in the database");
    ...
    void constructor_WithCreatedPetsOnly_ShouldCreateCorrectMessage() {
        ...
        assertThat(exception.getMessage())
            .isEqualTo("Cannot delete user 'admin@test.com' (ID: 2) because they have created 3 pet(s) that still exist in the database");
    ...
    void constructor_WithBothOwnedAndCreatedPets_ShouldCreateCorrectMessage() {
        ...
        assertThat(exception.getMessage())
            .isEqualTo("Cannot delete user 'user2@test.com' (ID: 3) because they have ownership of 1 pet(s) and created 2 pet(s) that still exist in the database");
    ...
    void constructor_WithSingleOwnedPet_ShouldUseSingularForm() {
        ...
        assertThat(exception.getMessage())
            .isEqualTo("Cannot delete user 'user@test.com' (ID: 1) because they have ownership of 1 pet(s) that still exist in the database");
        assertThat(exception.getOwnedPetCount()).isEqualTo(1);
        assertThat(exception.getCreatedPetCount()).isEqualTo(0);
    }
    ...
    void constructor_WithSingleCreatedPet_ShouldUseSingularForm() {
        ...
        assertThat(exception.getMessage())
            .isEqualTo("Cannot delete user 'user@test.com' (ID: 1) because they have created 1 pet(s) that still exist in the database");
        assertThat(exception.getOwnedPetCount()).isEqualTo(0);
        assertThat(exception.getCreatedPetCount()).isEqualTo(1);
    }
}