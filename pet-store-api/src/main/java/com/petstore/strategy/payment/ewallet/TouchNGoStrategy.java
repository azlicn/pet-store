...
@Component
public class TouchNGoStrategy implements EWalletStrategy {

    private static final Logger logger = LoggerFactory.getLogger(TouchNGoStrategy.class);
    ...
    public void processEWalletPayment(Payment payment, PaymentOrderRequest request) {
        ...
        logger.info("Processing TouchNGo payment: {}", payment.getAmount());
        payment.setPaymentNote(WalletType.TOUCHNGO.name() + " - " + request.getWalletId());
    }
